...
public class utils {
    ...
    public static void printCenter(String text, Graphics g, int height) {
        printCenter(text,g,height,Color.white);
    }
    public static void printCenter(String text, Graphics g) {
        printCenter(text,g,48,Color.white);
    }
